void ATestRun (const std::string& submitDir)
{
  ...
  const char* inputFilePath = gSystem->ExpandPathName ("/afs/cern.ch/work/b/bbullard/DRAW_ZMUMU/data17_13TeV/");
  ...
  //config.setType ("MuonAODAnalysis");
  config.setType ("MuonSelection");
